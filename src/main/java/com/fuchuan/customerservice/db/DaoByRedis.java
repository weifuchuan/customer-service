...
public class DaoByRedis implements IDao {
  ...
  @Override
  public int onlineCountForUserId(String userId) {
    RedisCommands<String, Object> sync = R.sync();
    Integer count = (Integer) sync.get(Db.K.onlineCount(userId));
  ...
  @Override
  public void incrOnlineCount(String userId) {
    R.sync().incr(Db.K.onlineCount(userId));
  }

  @Override
  public void decrOnlineCount(String userId) {
