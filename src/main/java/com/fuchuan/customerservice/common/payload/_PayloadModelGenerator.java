...
public class _PayloadModelGenerator {
  ...
  static String OUTPUT_DIR = "com/fuchuan/customerservice/common/payload";

  public static void main(String[] args) {
    String payloadModelTmpl =
        FileUtil.readString(
            PathKit.getWebRootPath()
                + "/src/main/java/com/fuchuan/customerservice/common/payload/_payload-model.enjoy",
            "UTF-8");
    String payloadModelTSTmpl =
        FileUtil.readString(
            PathKit.getWebRootPath()
                + "/src/main/java/com/fuchuan/customerservice/common/payload/_payload-model-ts.enjoy",
            "UTF-8");
